...
public class EingabeFormulare {
	...
	public static List<String> getFelderForTyp(EingabeTypen typ) {
	    return switch (typ) {
	        case USER -> List.of("ID", "Name", "Vorname", "Adresse", "Geburtstag", "Führerscheininformation", "Status");
	...
	public static void verarbeiteDaten(EingabeTypen typ, Map<String, String> daten) {
	    ...
	    Mietvertraege db4= new Mietvertraege();
	    ...
	    try {
	        switch (typ) {
	            case USER -> {
	                ...
	                // DB-Aufruf
	                db.addUser(id, name, vorname, adresse, sqlDate, fuehrerschein, istFrei);
